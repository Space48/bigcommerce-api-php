...
namespace Space48\Bigcommerce\Requests\OrderStatus;
 ...
 * |
 * |:--|:--|:--|
 * | 0 | Incomplete  | An incomplete order happens when a shopper reached the payment
 * page, but did not complete the transaction. |
 * | 1 | Pending |Customer started the checkout process,
 ...
 * refunded the order. |
 */
class GetOrderStatusesStatus extends Request
{
	...
	{
		return "/order_statuses/{$this->statusId}";
	}
