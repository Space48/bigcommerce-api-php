...
use Space48\Bigcommerce\Requests\WebhooksAdmin\UpdateHooksAdmin;
...
class WebhooksAdmin extends Resource
{
	...
	public function updateHooksAdmin(): Response
	{
		return $this->connector->send(new UpdateHooksAdmin());
	}
}
